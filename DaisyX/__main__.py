...
PM_START_TEXT = """
Hello there, I'm [🔥Lucy Al🔥](https://telegra.ph/file/8bac316b41519b7c97b71.jpg)
...
buttons = [
    [
        InlineKeyboardButton(text="ℹ️ INFO ℹ️", callback_data="aboutmanu_"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="💫 Add 🔥Lucy Al🔥 to your group 💫", url="t.me/daisyXBot?startgroup=true"
        ),
    ],
]
...
HELP_STRINGS = f"""
*Main Commands :* [🤖](https://telegra.ph/file/8bac316b41519b7c97b71.jpg)
...
Support them  [Artboylk](https://youtube.com/channel/UCFH_E0cu7U8GMjEJGnSvYjA),"""
